...
import { createNotifySubscriber, getNotifySubscribers } from './notifySubscribers';
...
// Note: /:id wildcard must come after more specific routes
router.get('/:id', vehicleController.getVehicleById);
router.post('/:id/view', vehicleController.incrementViewCount);

router.patch('/:id/status', auth, adminOnly, vehicleController.updateStatus);
router.patch('/:id/featured', auth, adminOnly, vehicleController.toggleFeatured);
